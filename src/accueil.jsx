...
const productCategories = [
  ...
  { id: 2, title: 'CATÉGORIE 2', description: 'Description de la catégorie 2', products: [{ image: '/images/product4.jpg', title: 'PROD 4', description: 'Description du produit 4' }, { image: '/images/product5.jpg', title: 'PROD 5', description: 'Description du produit 5' }, { image: '/images/product6.jpg', title: 'PROD 6', description: 'Description du produit 6' }] },

...
import '../css/OrderDetail.css'; // Importez votre fichier CSS pour le style
            ...
            <ul className="product-list">
                {order.orderDetails.map((detail) => (
                    <li key={detail.product.productId} className="detail-item">
                        {detail.product.productPhotos && detail.product.productPhotos.length > 0 && (
                            <img
                                src={`${baseUrl}${detail.product.productPhotos[0].photoUrl}`} // Concaténation de l'URL de base
                        ...
                        <div className="product-details">
                            ...
                            <p>Prix unitaire: {parseFloat(detail.product.prix).toFixed(2)} €</p>
                        </div>
                    </li>
                ))}
            </ul>
